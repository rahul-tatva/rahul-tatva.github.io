    ...
    if (window.DotMetricsInitScript == undefined) {
        ...
        function start(hasConsent){
            ...
            if(!hitDone){
                var imgUrl = 'https://uk-script.dotmetrics.net/hit.gif?id=4637&url=' + pageUrl + '&dom=' + domain + '&r=' + rand + '&pvs=' + pvs + '&pvid=' + pvid + '&c=' + hasConsent;
                var im=new Image;
                im.src = imgUrl;
                        ...
                        window.DotMetricsSettings =
                                    {
                                        ...
                                        ScriptUrl:  'https://uk-script.dotmetrics.net/Scripts/script.js?v=183',
                                        ScriptDebugUrl:  'https://download.dotmetrics.net/Script/script.debug.js?v=678b1018-7aaf-47ac-abce-c25357a00e1f',
                                        ...
                                        AdexEnabled: false,
                                        AdexConfigUrl: 'https://script.api/DotMetrics.Script.Adex/adexConfig.js?v=183&id=4637',
